...
func TestRunStateSyncsAllocationBeforeStart(t *testing.T) {
	...
	app := NewApp(Config{Home: home, Control: filepath.Join(home, ".multiegg"), AllocationPort: 30128}, catalog, bytes.NewReader(nil), &output, &output)
